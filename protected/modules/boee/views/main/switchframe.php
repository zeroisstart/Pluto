...
<body onload="MyLoad()">
<div  id="switchpic"><a href="javascript:Submit_onclick()"><img src="../../images/switch_left.gif" alt="隐藏左侧导航栏" name="ImgArrow" id="ImgArrow" /></a></div>
</body>
</html>
