...
<div class="main">
  <div class="f_16" style="text-align:center"><b >恭喜您，<?php echo $title;?>闯关成功！</b></div>
 <br />
...
注：如果下一关闯关失败，之前得的所有奖品都没了哦！请慎重！！！
 ...
 <br />
<p>
	<a href="<?php echo $this -> createUrl('/boee/survey/go'.$step,array('fromuser'=>$fromuser,'ids'=>implode(',', $ids)));?>">
